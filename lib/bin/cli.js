...
program
    ...
    console.log("    ".concat(green('$'), " cimi patchBeta [branch] (default: master)"));
    console.log("    ".concat(green('$'), " cimi minorBeta [branch] (default: master)"));
    console.log("    ".concat(green('$'), " cimi majorBeta [branch] (default: master)"));
    console.log('');
})
    .parse(process.argv);
