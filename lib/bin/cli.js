...
program
    ...
    console.log("    ".concat(green('$'), " cimi patch--beta [branch] (default: master)"));
    console.log("    ".concat(green('$'), " cimi minor--beta [branch] (default: master)"));
    console.log("    ".concat(green('$'), " cimi major--beta [branch] (default: master)"));
    console.log('');
})
    .parse(process.argv);
